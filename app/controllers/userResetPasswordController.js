...
exports.forgotPassword = (req, res) => {
  ...
  User.findByEmail(email_add, (err, data) => {
    if (err) {
      ...
      // const resetLink = `http://localhost:8000/api/v1/resetpassword/${token}`;13.237.23.153
      // const resetLink = `http://13.237.23.153:8000/api/v1/resetpassword/${token}`; 
      const resetLink = `http://13.237.23.153:8000/api/v1/resetpassword/${token}`; 
